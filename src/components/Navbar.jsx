...
const Navbar = memo(function Navbar() {
  ...
  return (
    <div className={`w-full fixed z-50 flex justify-center px-4 sm:px-6 lg:px-8 transition-all duration-500 ${
      isScrolled ? 'top-0 sm:top-2' : 'top-0 sm:top-4'
    }`}>
      <nav className={`w-full max-w-7xl backdrop-blur-xl border transition-all duration-500 ${
        isScrolled 
          ? 'bg-white/80 border-white/60 shadow-[0_12px_40px_0_rgba(22,163,74,0.15)] rounded-b-2xl rounded-t-none sm:rounded-2xl py-1' 
          : 'bg-white/30 border-white/50 shadow-[0_8px_32px_0_rgba(31,38,135,0.1)] rounded-2xl py-0'
      } text-green-900`}>
