...
import iptekImg from '../../assets/Divisi-iptek.webp';
import organisasiImg from '../../assets/divisiOrganisasi.webp';
import litbangImg from '../../assets/divisiLitbang.webp';
import bismitImg from '../../assets/divisiBismit.webp';
import olahragaImg from '../../assets/divisiOlahraga.webp';
import medinfoImg from '../../assets/divisiMedinfo.webp';
import kerohanianImg from '../../assets/divisiKerohanian.webp';
      ...
      <div className="flex flex-wrap justify-center gap-6 lg:gap-7">
        {divisiData.map((divisi, idx) => (
          <div
            ...
            data-idx={idx}
            className="w-full sm:w-[calc(50%-12px)] lg:w-[calc(25%-21px)] max-w-sm"
          >
